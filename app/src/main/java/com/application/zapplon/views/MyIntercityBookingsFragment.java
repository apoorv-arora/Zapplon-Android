 ...
 */
public class MyIntercityBookingsFragment extends Fragment implements UploadManagerCallback {
    ...
    private ArrayList<TaxiBookings> wishes;
    ...
    private class GetHistory extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            try {
                ...
                String url = "";
                url = CommonLib.SERVER + "intercity/bookings/?start=0&count=" + count;
                Object info = RequestWrapper.RequestHttp(url, RequestWrapper.MY_INTERCITY_BOOKINGS, RequestWrapper.FAV);
        ...
        protected void onPostExecute(Object result) {
            ...
            if (result != null) {
                ...
                if (result instanceof Object[]) {
                    ...
                    setWishes((ArrayList<TaxiBookings>) arr[1]);
    ...
    public class WishesAdapter extends ArrayAdapter<TaxiBookings> {

        private List<TaxiBookings> wishes;
        private Activity mContext;
        private int width;
        String otherReason = "";

        public WishesAdapter(Activity context, int resourceId, List<TaxiBookings> wishes) {
        ...
        public View getView(int position, View v, ViewGroup parent) {
            final TaxiBookings wish = wishes.get(position);
            ...
            viewHolder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if( System.currentTimeMillis() - wish.getStartDate() < 2 * 60 * 1000 * 60 * 24) {
                        Intent bookingIntent = new Intent(mContext, Home.class);
                        bookingIntent.putExtra("intercityBookingStatus", true);
    ...
    private void setWishes(ArrayList<TaxiBookings> wishes) {
        this.wishes = wishes;
    ...
    private class LoadModeWishes extends AsyncTask<Integer, Void, Object> {
        ...
        protected Object doInBackground(Integer... params) {
            ...
            try {
                ...
                url = CommonLib.SERVER + "intercity/bookings/?start=" + start + "&count=" + count;
                Object info = RequestWrapper.RequestHttp(url, RequestWrapper.MY_INTERCITY_BOOKINGS, RequestWrapper.FAV);
                CommonLib.ZLog("url", url);
                return info;
        ...
        protected void onPostExecute(Object result) {
            ...
            if (result != null && result instanceof Object[]) {
                Object[] arr = (Object[]) result;
                wishes.addAll((ArrayList<TaxiBookings>) arr[1]);
